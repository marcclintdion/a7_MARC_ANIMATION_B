...
/*         
         ...
         out_Init << "//------------------------------------------------------------------------------------------|___LOAD_VBO                                        "        << "\n";  
         out_Init << "#include    \"sphere.cpp\"                                                                                                                "        << "\n";
         out_Init << "glGenBuffersARB(1,              &sphere_VBO);                                                                                             "        << "\n";
         out_Init << "glBindBufferARB(GL_ARRAY_BUFFER, sphere_VBO);                                                                                             "        << "\n";
         out_Init << "glBufferDataARB(GL_ARRAY_BUFFER, sizeof(sphere), sphere, GL_STATIC_DRAW);                                                           "        << "\n";
...
//--------------------------------------------------------
         ...
         out_ShutDown << "            glDeleteTextures( 1,    &sphere_TEXTURE1);                                                                             "        << "\n";                            
         out_ShutDown << "            glDeleteTextures( 1,    &sphere_NORMAL_TEX);                                                                           "        << "\n";                                                                              
         out_ShutDown << "            glDeleteBuffersARB(1,   &sphere_VBO);                                                                                  "        << "\n";                                                                                                                                 
