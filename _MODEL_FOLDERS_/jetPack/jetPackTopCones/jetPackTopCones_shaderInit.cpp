    ...
    jetPackTopCones_SHADER_Vertex = glCreateShaderObjectARB( GL_VERTEX_SHADER_ARB );
	 ...
	 unsigned char *jetPackTopCones_SHADER_VertexAssembly   = readShaderFile( "_MODEL_FOLDERS_/jetPack/jetPackTopCones/jetPackTopCones.vert" );
    ...
    unsigned char *jetPackTopCones_SHADER_FragmentAssembly = readShaderFile( "_MODEL_FOLDERS_/jetPack/jetPackTopCones/jetPackTopCones.frag" );
