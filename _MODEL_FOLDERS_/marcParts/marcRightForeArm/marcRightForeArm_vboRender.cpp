              ...
              //SPECULAR_textureID;
              //SPECULAR_textureID = glGetUniformLocationARB(marcRightForeArm_SHADER,"SpecularMap");
              //glUniform1iARB(SPECULAR_textureID, 2);
              //glActiveTextureARB(GL_TEXTURE2_ARB);
              //glBindTexture(GL_TEXTURE_2D,  specularMap[207]);

              DOT3_textureID;
              DOT3_textureID     = glGetUniformLocationARB(marcRightForeArm_SHADER,"NormalMap");
              glUniform1iARB(DOT3_textureID, 1);
              glActiveTextureARB(GL_TEXTURE1_ARB);
              glBindTexture(GL_TEXTURE_2D,  normalMap[207]);

              textureID;
              textureID     = glGetUniformLocationARB(marcRightForeArm_SHADER,"Texture1");
              glUniform1iARB(textureID, 0);
              glActiveTextureARB(GL_TEXTURE0_ARB);
              glBindTexture(GL_TEXTURE_2D, textureMap[207]);

              //glLightfv(GL_LIGHT0,GL_POSITION,lightPos_marcRightForeArm);
              //glLightf (GL_LIGHT0, GL_QUADRATIC_ATTENUATION, lightAttenuation_marcRightForeArm);
