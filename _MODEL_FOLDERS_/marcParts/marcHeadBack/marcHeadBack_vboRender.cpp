              ...
              //SPECULAR_textureID;
              //SPECULAR_textureID = glGetUniformLocationARB(marcHeadBack_SHADER,"SpecularMap");
              //glUniform1iARB(SPECULAR_textureID, 2);
              //glActiveTextureARB(GL_TEXTURE2_ARB);
              //glBindTexture(GL_TEXTURE_2D,  specularMap[200]);

              DOT3_textureID;
              DOT3_textureID     = glGetUniformLocationARB(marcHeadBack_SHADER,"NormalMap");
              glUniform1iARB(DOT3_textureID, 1);
              glActiveTextureARB(GL_TEXTURE1_ARB);
              glBindTexture(GL_TEXTURE_2D,  normalMap[200]);

              textureID;
              textureID     = glGetUniformLocationARB(marcHeadBack_SHADER,"Texture1");
              glUniform1iARB(textureID, 0);
              glActiveTextureARB(GL_TEXTURE0_ARB);
              glBindTexture(GL_TEXTURE_2D, textureMap[200]);

              //glLightfv(GL_LIGHT0,GL_POSITION,lightPos_marcHeadBack);
              //glLightf (GL_LIGHT0, GL_QUADRATIC_ATTENUATION, lightAttenuation_marcHeadBack);
